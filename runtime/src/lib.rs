...
use pallet_erc20::{AfterTransfer, BeforeTransfer};
...
pub struct TokenTransferEvents;
impl AfterTransfer<AccountId> for TokenTransferEvents {
	fn after_transfer(_from: Option<&AccountId>, _to: &AccountId, _amount: U256) {}
}

impl BeforeTransfer<AccountId> for TokenTransferEvents {
	fn before_transfer(_from: Option<&AccountId>, _to: &AccountId, _amount: U256) {}
}

impl pallet_erc20::Config for Runtime {
	type Event = Event;
	type AfterTransfer = TokenTransferEvents;
	type BeforeTransfer = TokenTransferEvents;
	type Decimals = Decimals;
	type Name = Name;
	type Symbol = Symbol;
	type WeightInfo = weights::pallet_erc20::WeightInfo<Runtime>;
}
